...
export default function About() {
  ...
  return (
    <section id="about" className="relative bg-cream py-16 md:py-24 overflow-hidden">
      ...
      <Image
        src="/images/backgrounds/about-wave.png"
        alt=""
        fill
        aria-hidden
        ...
        <div className="mt-10 md:mt-14 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          {t.about.skills.map((skill, idx) => (
            <Reveal key={skill.id} delay={idx * 60}>
              <div className="bg-white/90 backdrop-blur-sm rounded-card p-4 md:p-5 border border-coral/15 shadow-soft hover:shadow-card hover:-translate-y-1 transition-all duration-300 h-full flex flex-col items-center text-center">
